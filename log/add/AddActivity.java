...
import com.zggk.newiroad.utils.TimeSelectHPopupwindow;
import com.zggk.newiroad.utils.TimeSelectPopupWindow;
...
private String str = "正在加载...";
    ...
    private void initpopu() {
        ...
        tqlist.add("小雨");
        tqlist.add("中雨");
        tqPop = new DiseaeNewSelectObjectPopupWindow(AddActivity.this, "请选择当前天气", tqlist, new DiseaseNewSelectObjectListener() {
            @Override
            public void selectPosition(int position) {
//                mrtq=listTqResult.get(position);
    ...
    private void linstener() {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LXlist.size() == 0) {
                    logRecordInfo.setLDMC(replaceNull(MRld));//路段名称
                } else {
        ...
        addlog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getnr();
                showLoadingDialogMethod(str);
                if (Utils.isNetworkAvailable(AddActivity.this) == false) {//没网
                    ...
                    if (LXlist.size() == 0) {
                        addLogjson.setLDMC(replaceNull(MRld));//路段名称
                    } else {
                    ...
                    if (dclx.getText().toString()!=null&&!dclx.getText().toString().equals("")){
    ...
    private void setdate() {
        ...
        dqtq.setText("晴");
        dclx.setText(listDclxInfoResult.get(0).getDCMC());
    ...
    private void initdate() {
        ...
        ldPop = new popuwindosa(AddActivity.this, "请选择路线", listLdResult, new popuwindowsslistener() {//路线弹窗
            @Override
            public void selectPosition(List<String> lxlistdate, List<Integer> lxposition) {
                if (lxlistdate.size() == 0) {
                    ...
                    setadapter();
                    for (int i = 0; i < lxlistdate.size(); i++) {
    ...
    private void initview() {
        ...
        View diseaseView = LayoutInflater.from(AddActivity.this).inflate(R.layout.layout_looklog, null, false);
