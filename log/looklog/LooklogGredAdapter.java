 ...
 * @author xiaoqing
 */
public class LooklogGredAdapter extends BaseAdapter {
    ...
    public LooklogGredAdapter(Context context,
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (showType == 1) {
            ...
            if (position == listPicture.size() - 1) {
                vh.pictureCloseImg.setVisibility(View.GONE);
                if (context instanceof LooklogActivity) {
                    vh.pictureImg.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (minePopupWindow == null) {
                                minePopupWindow = new MinePopupWindow((LooklogActivity) context, itemOnClick);
                            }
                            minePopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
                            Utils.hideInputWindow((LooklogActivity)context);
                        }
                    });
                }
            } else {
    ...
    public void getPicFromPhoto() {
        ...
        ((LooklogActivity) context).startActivityForResult(intent, CHOOSE_PICTURE_CODE);
    }
    ...
    public void getPicFromCamera() {
        ...
        ((LooklogActivity) context).setCameraPath(path);
        ((LooklogActivity) context).setChildViewPosition(childViewPosition);
        ((LooklogActivity) context).startActivityForResult(intent, CAMERA_CODE);
    }
