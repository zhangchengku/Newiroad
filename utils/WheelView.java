...
public class WheelView extends View {
	...
	/** Top and bottom shadows colors */
	private  int[] shadowsColors=new int[] { 0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF };
	 ...
	 * Constructor 
	 */
	public WheelView(Context context, int [] shadowsColors) {
		super(context);
		initData(context);
