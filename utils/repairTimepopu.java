...
public class repairTimepopu extends PopupWindow implements View.OnClickListener {
    /******************控件声明**********************/
    ...
    public repairTimepopu(Activity activity,PopSelectListener listener) {
...
//                }
    ...
    public void show(View anchor) {
        ...
        if (anchor != null) {
            ...
            if (activity instanceof RepairActivity) {
                ((RepairActivity)activity).showZheZhaoView();
            }
        }
    }
