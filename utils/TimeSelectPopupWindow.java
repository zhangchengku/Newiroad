...
import com.zggk.newiroad.utils.OnWheelChangedListener;
import com.zggk.newiroad.utils.OnWheelScrollListener;
import com.zggk.newiroad.utils.PopMyDataSelectAdapter;
import com.zggk.newiroad.utils.PopSelectListener;
import com.zggk.newiroad.utils.WheelView;
...
public class TimeSelectPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public TimeSelectPopupWindow(Activity activity, PopSelectListener listener) {
...
//                if(activity instanceof DiseaseNewActivity){
//                    ((DiseaseNewActivity)activity).hideZheZhaoView();
//                }
            }
        });
...
//            if (activity instanceof DiseaseNewActivity) {
//                ((DiseaseNewActivity)activity).showZheZhaoView();
//            }
        }
    }
